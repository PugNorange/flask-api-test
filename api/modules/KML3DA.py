...
class KML3DA:
    ...
    # Generate KML file
    def generateKML(self, downloadLocation, inputFilePath, outputFileName, selectedDotColor, selectedPathColor):
        outPutFile  = downloadLocation + "/" + outputFileName + ".kml"     # kml file to save results
